const DaysChallange = () => {
    return (
        <div className="">
            <div className="grid rounded-2xl lg:justify-evenly lg:items-center gap-5  lg:grid-cols-3 grid-cols-1 lg:w-[1236px] m-auto  bg-gradient-to-r from-[#6462F0] to-[#9190E9] lg:mt-[130px] lg:h-[300px]">
