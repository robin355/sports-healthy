const DaysChallange = () => {
    return (
        <div className="grid lg:ml-10  rounded-3xl justify-between items-center lg:mr-10 lg:grid-cols-3 grid-cols-1 lg:h-[274px] bg-gradient-to-r from-[#6462F0] to-[#9190E9] mt-[130px]">
